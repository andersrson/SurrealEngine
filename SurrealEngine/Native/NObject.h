...
public:
	...
	static void Array_Size_U227(ScriptArray& Ar, std::optional<int> SetSize, int& ReturnValue);
	static void Array_Insert_U227(ScriptArray& Ar, int Offset, std::optional<int> Count, BitfieldBool& ReturnValue); // Insert space into a dynamic array. Returns false if it fails (bad parameters, const/private/inaccessible array)
	static void Array_Remove_U227(ScriptArray& Ar, int Offset, std::optional<int> Count, BitfieldBool& ReturnValue); // Remove space from a dynamic array. Returns false if fails.
	...
	static void GetConfig(const std::string& className, const std::string& propertyName, std::string& ReturnValue);
	...
	static void GetLanguage(std::string& ReturnValue);
	//}AUTOGENERATED
	static void ConcatEqual_StrStr(std::string& A, std::string& B, std::string& ReturnValue);

	static void GetConfigString_Nerf(const std::string& section, const std::string& key, const std::string& iniName, std::string& ReturnValue);
	static void SetConfigString_Nerf(const std::string& section, const std::string& key, const std::string& value, const std::string& iniName);
};
